import{c as g,Y as d,V as p,_ as h,p as S,W as D,Z as s,x as c,f,C as k,n as I,q as O,X as y,a as $,b as T,I as F,J as v,h as N,o as u}from"./index-DLtqyf7u.js";import{u as b}from"./index-Bz_Z-eFp-Bwy-olCH.js";var P=function(t,e,a,n){var r=arguments.length,i=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,a):n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,a,n);else for(var l=t.length-1;l>=0;l--)(o=t[l])&&(i=(r<3?o(i):r>3?o(e,a,i):o(e,a))||i);return r>3&&i&&Object.defineProperty(e,a,i),i};let A=class extends b{constructor(){super(...arguments),this.onOtpSubmit=async t=>{var e,a;try{if(this.authConnector){const n=k.state.activeChain,r=I.getConnections(n),i=(e=p.state.remoteFeatures)==null?void 0:e.multiWallet,o=r.length>0;if(await this.authConnector.provider.connectOtp({otp:t}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await I.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((a=p.state.remoteFeatures)!=null&&a.emailCapture)return;if(p.state.siwx){O.close();return}if(o&&i){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}O.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:y.parseError(n)}}),n}},this.onOtpResend=async t=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:t}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};A=P([u("w3m-email-verify-otp-view")],A);const W=F`
  wui-icon-box {
