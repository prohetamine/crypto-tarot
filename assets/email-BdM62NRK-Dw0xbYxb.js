import{c as g,Y as d,a as p,_ as h,I as S,z as D,b as s,v as c,f,C as k,n as I,q as O,X as y,d as T,l as $,k as F,J as v,j as N,o as u}from"./index-PiuF6ylp.js";import{u as b}from"./index-CCFl_lcq-DhzKIxVw.js";var P=function(t,e,a,n){var r=arguments.length,i=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,a):n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,a,n);else for(var l=t.length-1;l>=0;l--)(o=t[l])&&(i=(r<3?o(i):r>3?o(e,a,i):o(e,a))||i);return r>3&&i&&Object.defineProperty(e,a,i),i};let A=class extends b{constructor(){super(...arguments),this.onOtpSubmit=async t=>{var e,a;try{if(this.authConnector){const n=k.state.activeChain,r=I.getConnections(n),i=(e=p.state.remoteFeatures)==null?void 0:e.multiWallet,o=r.length>0;if(await this.authConnector.provider.connectOtp({otp:t}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),n)await I.connectExternal(this.authConnector,n);else throw new Error("Active chain is not set on ChainController");if((a=p.state.remoteFeatures)!=null&&a.emailCapture)return;if(p.state.siwx){O.close();return}if(o&&i){s.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}O.close()}}catch(n){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:y.parseError(n)}}),n}},this.onOtpResend=async t=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:t}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};A=P([u("w3m-email-verify-otp-view")],A);const j=F`
  wui-icon-box {
...
`;var C=function(t,e,a,n){var r=arguments.length,i=r<3?e:n,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,a,n);else for(var l=t.length-1;l>=0;l--)(o=t[l])&&(i=(r<3?o(i):r>3?o(e,a,i):o(e,a))||i);return r>3&&i&&Object.defineProperty(e,a,i),i};let m=class extends g{constructor(){var t,e;super(...arguments),this.formRef=T(),this.initialEmail=((t=s.state.data)==null?void 0:t.email)??"",this.redirectView=(e=s.state.data)==null?void 0:e.redirectView,this.email="",this.loading=!1}firstUpdated(){var t;(t=this.formRef.value)==null||t.addEventListener("keydown",e=>{e.key==="Enter"&&this.onSubmitEmail(e)})}render(){return h`
