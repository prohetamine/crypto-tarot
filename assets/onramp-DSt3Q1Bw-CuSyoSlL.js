import{c as w,H as c,n as q,y as m,_ as l,X as L,W as E,f as U,b as S,C as A,v as K,e as N,U as V,N as k,T as j,a as B,q as $,k as I,J as u,P as p,G as X,o as b}from"./index-CQz6Kw2o.js";const _=I`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var v=function(e,t,i,n){var o=arguments.length,r=o<3?t:n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(r=(o<3?s(r):o>3?s(t,i,r):s(t,i))||r);return o>3&&r&&Object.defineProperty(t,i,r),r};let h=class extends w{constructor(){super(...arguments),this.disabled=!1,this.color="inherit",this.label="",this.feeRange="",this.loading=!1,this.onClick=null}render(){return l`
    ...
    `}onRampProvidersTemplate(){return this.providers.filter(e=>e.supportedChains.includes(A.state.activeChain??"eip155")).map(e=>l`
          ...
          ></w3m-onramp-provider-item>
        `)}onClickProvider(e){var t;c.setSelectedProvider(e),S.push("BuyInProgress"),L.openHref(((t=c.state.selectedProvider)==null?void 0:t.url)||e.url,"popupWindow","width=600,height=800,scrollbars=yes"),K.sendEvent({type:"track",event:"SELECT_BUY_PROVIDER",properties:{provider:e.name,isSmartAccount:N(A.state.activeChain)===V.ACCOUNT_TYPES.SMART_ACCOUNT}})}};z([u()],W.prototype,"providers",void 0);W=z([b("w3m-onramp-providers-view")],W);const Q=I`
  :host > wui-grid {
    max-height: 360px;
    overflow: auto;
  }
...
`;var g=function(e,t,i,n){var o=arguments.length,r=o<3?t:n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(e,t,i,n);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(r=(o<3?s(r):o>3?s(t,i,r):s(t,i))||r);return o>3&&r&&Object.defineProperty(t,i,r),r};let d=class extends w{constructor(){super(),this.unsubscribe=[],this.selectedOnRampProvider=c.state.selectedProvider,this.uri=q.state.wcUri,this.ready=!1,this.showRetry=!1,this.buffering=!1,this.error=!1,this.isMobile=!1,this.onRetry=void 0,this.unsubscribe.push(c.subscribeKey("selectedProvider",e=>{this.selectedOnRampProvider=e}))}disconnectedCallback(){this.intervalId&&clearInterval(this.intervalId)}render(){var e,t;let i="Continue in external window";this.error?i="Buy failed":this.selectedOnRampProvider&&(i=`Buy in ${(e=this.selectedOnRampProvider)==null?void 0:e.label}`);const n=this.error?"Buy can be declined from your side or due to and error on the provider app":"We’ll notify you once your Buy is processed";return l`
    ...
    `}};D=Y([b("w3m-what-is-a-buy-view")],D);const G=I`
  :host {
    width: 100%;
  }
